...
import github.otowave.api.routes.music.services.faces.MusicFacesMaker;
...
@Service
public class MusicProfileMaker extends MusicFacesMaker {
    ...
    private Mono<MusicProfileModel> makeMusicProfile(Mono<MusicFaceModel> faceModel, MusicMetaEntity musicMetaEntity) {
        return faceModel.flatMap(face -> {
            ...
            LocalDateTime uploaded = musicMetaEntity.getUploaded();
